...
:: Android packaging
set AND_CERT_NAME="exDependency"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\exDependency.p12
...
set IOS_PROVISION_DEV=cert\exDependency.mobileprovision
...
set APP_ID=com.doitflash.exDependency

:: Output packages
set DIST_PATH=dist
set DIST_NAME=exDependency
